 ...
 */
    ...
    (() => {
        ...
        if (document.querySelector(".left-home__slider")) new core(".left-home__slider", {
        ...
        document.querySelectorAll(".block-slider__slider").forEach((container => {
            ...
            function smmSeoSliderInit() {
                if (!smmSeoSlider) smmSeoSlider = new core(container, {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    spaceBetween: 10,
            ...
            function handleResize() {
                ...
                if (windowWidth <= mediaQuerySize) smmSeoSliderInit(); else smmSeoSliderDestroy();
            }
        ...
        if (closeButton) closeButton.addEventListener("click", (function(e) {
            ...
            if (homeRight) homeRight.classList.add("hidden");
        }));
